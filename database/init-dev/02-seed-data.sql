-- Sales Reports Seed Data
  -- Generates 200 customers, 500 orders, and ~2000 order items to demonstrate N+1 query problem
  ...
  BEGIN
      ...
      FOR i IN 1..500 LOOP
          ...
          customer_id_val := 1 + (random() * 199)::INTEGER;
      ...
      RAISE NOTICE 'Seed data created: 200 customers, 500 orders, ~2000 order items';
  END $$;