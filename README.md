...
> 🐦 "Hey... so the sales team needs this orders report for their meeting, right? And they keep complaining that it takes forever to load. I checked the metrics and... yeah, something's off. It's just 500 orders but the system is struggling. The backend logs look... busy. I'd investigate more but I have a really important staring contest with my ceiling scheduled, so... could you take a look? Load that report and figure out why it's so slow. Thanks!"
